...
Project Name: Time-series Analysis - Prediction on prices of natural resources commodities (Crude Oil Originally)
...
Unlike traditional statistical modeling or machine learning, time-series analysis has very limited data: one at each timestamp. This project aims to examine some classical approaches to deal with time-series data, covering ARIMA (autoregressive integrated moving average), a statistical method popular for time-series in econometrics, as well as LSTM, the deep learning branch well-known for sequence tasks. More models and algorithms for time-series will be explored! Besides, we could do more EDAs to try to find relationships among oil price, gold price and the value of USD, gaining a better understanding of oil price as a real-world indicator.
...
-    Week 8: Time-series crash course: individual research and group seminar
-    Week 9: EDAs surrounding oil price (how it is influenced, influencing, and what it tells); Finalize Presentation
